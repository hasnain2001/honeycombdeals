...
<link rel="canonical" href="https://honeycombdeals.com">
  ...
  <!-- Your Open Graph Tags: go here -->
<!--  <meta property="og:title" content="Honeycomb Deals - Best Deals and Discounts">-->
<!--<meta property="og:description" content="Find the best deals, discounts, and coupons on Honeycomb Deals. Save money on your favorite products from top brands.">-->
<!--<meta property="og:image" content="https://www.honeycombdeals.com/images/logo.png">-->
<!--<meta property="og:url" content="https://www.honeycombdeals.com">-->
<!-- Your Twitter Card Tags: go here -->
<!--<meta name="twitter:card" content="summary_large_image">-->
<!--<meta name="twitter:site" content="@honeycombdeals">-->
<!--<meta name="twitter:title" content="Honeycomb Deals - Best Deals and Discounts">-->
<!--<meta name="twitter:description" content="Find the best deals, discounts, and coupons on Honeycomb Deals. Save money on your favorite products from top brands.">-->
<!--<meta name="twitter:image" content="https://www.honeycombdeals.com/images/logo.png">-->
...
<link rel="stylesheet" href="{{ asset('front/assets/css/home.css') }}">
    ...
    <!-- networks verification for website -->
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NJNM88GL" height="0" width="0"
 ...
 <div id="carouselExampleFade" class="carousel slide carousel-fade">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('front/assets/images/CPjEFG.png') }}" class="d-block w-100" alt="..." loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('front/assets/images/ZvPght.png') }}" class="d-block w-100" alt="..." loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('front/assets/images/BGRMCa.png') }}" class="d-block w-100" alt="..." loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('front/assets/images/tiSsDA.png') }}" class="d-block w-100" alt="..." loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('front/assets/images/slider.png') }}" class="d-block w-100" alt="..." loading="lazy">
        </div>
    </div>
