...
/* Base styles for both buttons (prev and next) */
.store-prev,
.store-next {
  position: absolute; /* Position buttons for overlaying */
...
/* Specific styles for prev button (optional) */
.store-prev {
  left: 10px; /* Adjust horizontal positioning */
}

.store-prev .store-prev-icon {
  margin-right: 5px; /* Spacing between icon and text */
}

/* Specific styles for next button (optional) */
.store-next {
  right: 10px; /* Adjust horizontal positioning */
}

.store-next .store-next-icon {
...
.store-prev-icon {
  content: "\f104"; /* Left arrow code using Font Awesome */
}

.store-next-icon {
  content: "\f105"; /* Right arrow code using Font Awesome */
}
...
.slider-prev-icon i, .slider-next-icon i {
    font-size: 30px; /* Increase the font size to make the icons larger */
    color: #fff;
}
...
.store {
background-color:white; /* Slightly transparent background for better visibility */
border-radius: 20%; /* Make the control icons circular */
